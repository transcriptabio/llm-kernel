...
def default_kernel_config():
  ...
  return scorer.KernelConfig(model_name='gemini/gemini-2.5-pro',
...
def example_rna_vs_rna():
  ...
  rna_x = data_models.RNASeq(id='sample_x',
                             gene_names=['GENE1', 'GENE2'],
                             lfc=[1.0, -0.5],
                             fdr=[0.01, 0.05])
  rna_y = data_models.RNASeq(id='sample_y',
                             gene_names=['GENE1', 'GENE2'],
                             lfc=[0.8, -0.3],
                             fdr=[0.02, 0.03])
...
def example_text_vs_text():
  ...
  # Score text pairs
  text_x = data_models.Text(id='text_x',
                            text='Rapid growth and proliferation of cells')
...
def example_text_vs_rna():
  ...
  # Score text vs RNA
  text_x = data_models.Text(id='text_x',
                            text='Inflammatory response and immune activation')
  rna_y = data_models.RNASeq(id='inflammatory_sample',
...
def example_kernel_pattern():
  ...
  x = data_models.RNASeq(id='sample_x',
                         gene_names=['IL1B', 'TNF', 'IFNG'],
                         lfc=[1.0, -0.5, 2.1],
                         fdr=[0.01, 0.05, 0.001])
  y = data_models.RNASeq(id='sample_y',
                         gene_names=['IL1B', 'TNF', 'IFNG'],
                         lfc=[0.8, -0.3, 1.8],
                         fdr=[0.02, 0.03, 0.002])
